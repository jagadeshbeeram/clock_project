...
HD_PWD='C:/Users/phani/vivado files/clock_project/clock_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_main_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_main_1.tcl -notrace
