...
HD_PWD='C:/Users/phani/vivado files/clock_project/clock_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_main_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_main_1.tcl
